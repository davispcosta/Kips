;(function () {
    ...
    var lazuliAnimate = function() {

		var lazuli = $('#fh5co-lazuli');
		if ( lazuli.length > 0 ) {	

			lazuli.waypoint( function( direction ) {
										
				if( direction === 'down' && !$(this.element).hasClass('animated') ) {


					setTimeout(function() {
						lazuli.find('.to-animate').each(function( k ) {
							var el = $(this);
					...
					setTimeout(function() {
						lazuli.find('.to-animate-2').each(function( k ) {
							var el = $(this);
					...
					setTimeout(function() {
						lazuli.find('.to-animate-3').each(function( k ) {
							var el = $(this);
